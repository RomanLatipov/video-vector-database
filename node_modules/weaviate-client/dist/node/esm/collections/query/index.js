      ...
      .then((search) => {
        return toBase64FromMedia(image).then((image) =>
          search.withNearImage(
            Object.assign(
              Object.assign({}, Serialize.nearImage(Object.assign({ image }, opts ? opts : {}))),
              { groupBy: Serialize.isGroupBy(opts) ? Serialize.groupBy(opts.groupBy) : undefined }
            )
          )
        );
        ...
        switch (type) {
          case 'audio':
            reply = toBase64FromMedia(media).then((media) =>
              search.withNearAudio(Serialize.nearAudio(Object.assign({ audio: media }, opts ? opts : {})))
            );
            break;
          case 'depth':
            reply = toBase64FromMedia(media).then((media) =>
              search.withNearDepth(Serialize.nearDepth(Object.assign({ depth: media }, opts ? opts : {})))
            );
            break;
          case 'image':
            reply = toBase64FromMedia(media).then((media) =>
              search.withNearImage(Serialize.nearImage(Object.assign({ image: media }, opts ? opts : {})))
            );
            break;
          case 'imu':
            reply = toBase64FromMedia(media).then((media) =>
              search.withNearIMU(Serialize.nearIMU(Object.assign({ imu: media }, opts ? opts : {})))
            );
            break;
          case 'thermal':
            reply = toBase64FromMedia(media).then((media) =>
              search.withNearThermal(
                Serialize.nearThermal(Object.assign({ thermal: media }, opts ? opts : {}))
              )
            );
            break;
          case 'video':
            reply = toBase64FromMedia(media).then((media) =>
              search.withNearVideo(Serialize.nearVideo(Object.assign({ video: media }, opts ? opts : {})))
            );
            break;
          default:
