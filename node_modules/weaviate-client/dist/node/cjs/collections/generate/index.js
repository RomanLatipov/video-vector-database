...
class GenerateManager {
  ...
  hybrid(query, generate, opts) {
    return Promise.all([
      ...
      .then((search) =>
        search.withHybrid(
          Object.assign(Object.assign({}, index_js_3.Serialize.hybrid(Object.assign({ query }, opts))), {
            generative: index_js_3.Serialize.generative(generate),
            groupBy: index_js_3.Serialize.isGroupBy(opts)
              ? index_js_3.Serialize.groupBy(opts.groupBy)
              : undefined,
      ...
      .then((search) =>
        (0, index_js_1.toBase64FromMedia)(image).then((image) =>
          search.withNearImage(
            Object.assign(
              Object.assign({}, index_js_3.Serialize.nearImage(Object.assign({ image }, opts ? opts : {}))),
              {
                generative: index_js_3.Serialize.generative(generate),
                groupBy: index_js_3.Serialize.isGroupBy(opts)
                  ? index_js_3.Serialize.groupBy(opts.groupBy)
    ...
    return this.checkSupportForNamedVectors(opts)
      ...
      .then((search) =>
        search.withNearObject(
          Object.assign(
            Object.assign({}, index_js_3.Serialize.nearObject(Object.assign({ id }, opts ? opts : {}))),
            {
              generative: index_js_3.Serialize.generative(generate),
              groupBy: index_js_3.Serialize.isGroupBy(opts)
                ? index_js_3.Serialize.groupBy(opts.groupBy)
  ...
  nearText(query, generate, opts) {
    return this.checkSupportForNamedVectors(opts)
      ...
      .then((search) =>
        search.withNearText(
          Object.assign(
            Object.assign({}, index_js_3.Serialize.nearText(Object.assign({ query }, opts ? opts : {}))),
            {
              generative: index_js_3.Serialize.generative(generate),
              groupBy: index_js_3.Serialize.isGroupBy(opts)
                ? index_js_3.Serialize.groupBy(opts.groupBy)
    ...
    return this.checkSupportForNamedVectors(opts)
      ...
      .then((search) =>
        search.withNearVector(
          Object.assign(
            Object.assign({}, index_js_3.Serialize.nearVector(Object.assign({ vector }, opts ? opts : {}))),
            {
              generative: index_js_3.Serialize.generative(generate),
              groupBy: index_js_3.Serialize.isGroupBy(opts)
                ? index_js_3.Serialize.groupBy(opts.groupBy)
            ...
            reply = (0, index_js_1.toBase64FromMedia)(media).then((media) =>
              search.withNearAudio(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.nearAudio(Object.assign({ audio: media }, opts ? opts : {}))
                  ),
                  { generative, groupBy }
                )
              )
            ...
            reply = (0, index_js_1.toBase64FromMedia)(media).then((media) =>
              search.withNearDepth(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.nearDepth(Object.assign({ depth: media }, opts ? opts : {}))
                  ),
                  { generative, groupBy }
                )
              )
            ...
            reply = (0, index_js_1.toBase64FromMedia)(media).then((media) =>
              search.withNearImage(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.nearImage(Object.assign({ image: media }, opts ? opts : {}))
                  ),
                  { generative, groupBy }
                )
              )
            ...
            reply = (0, index_js_1.toBase64FromMedia)(media).then((media) =>
              search.withNearIMU(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.nearIMU(Object.assign({ imu: media }, opts ? opts : {}))
                  ),
                  { generative, groupBy }
                )
              )
            ...
            reply = (0, index_js_1.toBase64FromMedia)(media).then((media) =>
              search.withNearThermal(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.nearThermal(Object.assign({ thermal: media }, opts ? opts : {}))
                  ),
                  { generative, groupBy }
                )
              )
            ...
            reply = (0, index_js_1.toBase64FromMedia)(media).then((media) =>
              search.withNearVideo(
                Object.assign(
                  Object.assign(
                    {},
                    index_js_3.Serialize.nearVideo(Object.assign({ video: media }, opts ? opts : {}))
                  ),
                  { generative, groupBy }
                )
              )
